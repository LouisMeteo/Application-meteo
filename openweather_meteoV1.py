...
orientation_capteur = input("Entrez l'orientation du capteur en degré :")  # Orientation du capteur solaire (en degrés)
inclinaison_capteur = input("Entrez l'inclinaison du capteur en degré :")  # Inclinaison du capteur solaire (en degrés)
...
# 7 # 7 # 7 # 7 # 7 # 7 # 7 # 7 # 7 # 7 
api_key = "api key"  # Enter the API key you got from the OpenWeatherMap website
...
while True:
    ...
    if x["cod"] != "404":
        ...
        write_api.write(bucket="meteo",
                ...
                record_field_keys=["current_temperature","temperature_felt","current_humidity","current_precipitations","current_wind_speed","wind_gust","wind_direction","rayonnement","weather_id","lat","lon","production"])
